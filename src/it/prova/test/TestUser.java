...
public class TestUser {
	...
	private static void testCercaTuttiQuelliCheUsernameIniziaCon(UserService userService) throws Exception {
		System.out.println("Inizio testCercaTuttiQuelliCheUsernameIniziaCon");
		List<User> elencoUserPresenti = userService.listAll();
		if (elencoUserPresenti.size() < 0)
			throw new RuntimeException(
					"testCercaTuttiQuelliCheUsernameIniziaCon fallito! Non ci sono user sul database!");
		List<User> result = userService.cercaTuttiQuelliCheUsernameIniziaCon("a");
